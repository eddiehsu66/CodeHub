...
HD_PWD='C:/code/hub/vivado_pro/Test/Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log multiCycleCPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source multiCycleCPU.tcl
