...
HD_PWD='C:/code/hub/vivado_pro/Test/Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log multiCycleCPU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source multiCycleCPU.tcl -notrace
